...
public class ContactDAO {
  ...
  private static PrimaryIndex<String, Contact> contactIndex; 
  ...
  static {
    ...
    ContactDAO.store = new EntityStore(env, "EntityStore", storeConfig);
    contactIndex = store.getPrimaryIndex(String.class, Contact.class); 
   ...
   */
  public static Contact getContact(String uniqueID) {
