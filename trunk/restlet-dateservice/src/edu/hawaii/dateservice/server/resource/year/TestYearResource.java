package edu.hawaii.dateservice.server.resource.year;
...
/**
 * Tests the operations supported for the DateServer year resource.
 * @author Philip Johnson
 */
public class TestYearResource {
  ...
  /**
   * Test the GET method of the year resource.
   * @throws Exception If problems occur. 
   */
  @Test
  public void testGet() throws Exception {
    // Try to retrieve the year from the DateServer.
    String testUrl = String.format("http://localhost:%s/dateserver/year", testPort);
    ...
    assertEquals("Testing year", currYear, response);
  }
}
